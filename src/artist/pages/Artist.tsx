...
export default function AdminsManager() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-purple-950 to-slate-950 text-slate-200 p-6 font-sans">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
          ...
          <div className="relative flex-1 lg:min-w-75 max-w-md">
        ...
        {/* --- MAIN TABLE --- */}
        <div className="bg-white/2 backdrop-blur-md border border-white/10 rounded-[2.5rem] overflow-hidden shadow-2xl">
          {loading ? (
            ...
            <div className="overflow-x-auto">
                    ...
                    <tr key={a.id} className="group hover:bg-white/3 transition-colors">
                      <td className="p-6">
                        <div className="flex items-center gap-4">
                          <div className="w-12 h-12 rounded-2xl bg-linear-to-br from-purple-500 to-pink-500 flex items-center justify-center text-white font-bold ring-2 ring-white/5 group-hover:ring-purple-500/30 transition-all">
                      ...
                      <td className="p-6">
                        <span className={`inline-block px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border ${a.status === 'active'
              ...
              {filtered.length === 0 && !loading && (
                <div className="py-24 text-center">
                  <div className="inline-flex p-8 bg-white/5 rounded-4xl mb-6 text-slate-700">
                    <FaSearch size={40} />
                  </div>
