...
export default function ArtistOnboarding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-900 p-6 text-white flex items-center justify-center">
      <div className="w-full max-w-2xl bg-white/3 border border-white/10 rounded-3xl p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
          ...
          <div className="flex flex-col items-end">
            <button disabled={busy} onClick={handleCreate} className="px-6 py-3 rounded-2xl bg-gradient-to-r from-blue-500 to-blue-600 font-bold">
