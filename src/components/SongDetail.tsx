    ...
    <div className="flex flex-col h-screen bg-black text-gray-400 font-sans overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        <main className="flex-1 flex flex-col overflow-y-auto hide-scrollbar relative">
          ...
          <div className="relative shrink-0 min-h-112.5 flex flex-col justify-end p-12 bg-cover bg-center"
        ...
        {showSidebar && (
          <aside className="w-95 bg-linear-to-b from-[#0a0a1a] to-[#1a0a2e] border-l border-white/10 p-5 flex flex-col gap-5 overflow-y-auto animate-in slide-in-from-right">
            ...
            <div className="relative bg-linear-to-br from-blue-600/20 to-purple-600/20 rounded-[30px] p-8 border border-blue-500/30 flex items-center justify-center min-h-70">
              <img
                src={albumCover}
                alt={albumTitle}
