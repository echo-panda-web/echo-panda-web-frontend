            ...
            <div className="flex gap-5 overflow-x-auto pb-6 no-scrollbar mask-fade-right mt-5">
              ...
              {playlists.map(p => (
                <div
                  ...
                  className={`group shrink-0 w-44 p-5 rounded-4xl cursor-pointer transition-all duration-300 relative ${selectedPlaylistId === p.id ? 'bg-white/15 ring-2 ring-white/20' : 'bg-white/5 hover:bg-white/10'
                    }`}
                >
                  <button
