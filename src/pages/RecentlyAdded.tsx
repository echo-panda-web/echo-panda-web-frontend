...
const RecentlyAdded: React.FC = () => {
    ...
    try {
      ...
      const data = await getCachedData('recently_added_songs', async () => {
        ...
        const transformedSongs: Song[] = (songsData || []).map((song: any) => ({
          ...
          original_key: song.audio_url || song.original_key,
  ...
  return (
    <div className={`min-h-screen ${isLightMode ? "bg-gray-50" : "bg-black"} ${isLightMode ? "text-gray-900" : "text-white"} py-8`}>
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="mb-8 flex items-center justify-between">
          ...
          <p className={`${isLightMode ? "text-gray-500" : "text-slate-400"} text-lg`}>Latest 25 tracks added to the collection</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-32">
            ...
            <p className={`${isLightMode ? "text-gray-500" : "text-slate-400"} text-xl`}>No songs added yet</p>
          </div>
        ) : (
